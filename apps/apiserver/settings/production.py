...
SECRET_KEY = 'django-insecure-^60+3d$+$r*2efqm*7jxq0drrz4#z_#2ul(v!(!shee%^bjzt^'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'features.pagination.CustomPagination',
    'PAGE_SIZE': 20,
...
DB_HOST = getenv("DB_HOST", '10.157.86.34')
DB_PORT = getenv("DB_PORT", 5432)
DB_USER = getenv("DB_USER", 'postgres')
DB_PASS = getenv("DB_PASS", 'postgres')
DB_NAME = getenv("DB_NAME", 'fci')
